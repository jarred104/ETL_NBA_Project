...
CREATE TABLE "player_stats_2014" (
    ...
    "pf" int   NOT NULL,
    "pts" int   NOT NULL,
    CONSTRAINT "pk_player_stats_2014" PRIMARY KEY (
        "player_id"
     )
);
...
ALTER TABLE "player_stats_2014" ADD CONSTRAINT "fk_player_stats_2014_player_id_player_lastname_player_firstname" FOREIGN KEY("player_id", "player_lastname", "player_firstname")
REFERENCES "players" ("player_id", "player_lastname", "player_firstname");
